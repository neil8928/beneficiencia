...
<html lang="{{ app()->getLocale() }}">
  <head>
    ...
    <meta name="description" content="Sistemas de Fichas Socioeconomicas">
    ...
    <title>{{ $Empresa }} - Inicio Sessión</title>
        ...
        <div class="main-content container-fluid">
          <div class="splash-container">
            <div class="panel panel-default panel-border-color panel-border-color-danger">
              ...
              <img src="{{ asset('public/img/'.$logo) }}" alt="logo" width="300" height="130" class="logo-img">
              ...
              <div class="panel-body">
                ...
                <form method="POST" action="{{ url('login') }}">
                  ...
                  <div class="form-group login-submit">
                    <button data-dismiss="modal" type="submit"  class="btn btn-danger btn-xl">Inicia sesión</button>
                  </div>
