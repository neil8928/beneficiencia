		...
		<div class="row">
			<div class="col-md-12">
				<div class="panel panel-default panel-border-color panel-border-color-primary">
					<div class="panel-heading panel-heading-divider">REVERTIR PRE APROBAR FICHA SOCIOECONOMICA<span class="panel-subtitle">Revertir Pre Aprobar Ficha
					...
					<div class="panel-body">
						...
						<form name="frmrevertirpreaprobacionficha" id='frmrevertirpreaprobacionficha' method="POST" action="{{ url('/revertir-pre-aprobacion-ficha-socieconomica/'.$idopcion.'/'.$idregistro) }}" style="border-radius: 0px;" class="form-horizontal group-border-dashed" enctype="multipart/form-data">
								{{ csrf_field() }}
