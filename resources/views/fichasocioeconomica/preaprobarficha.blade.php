		...
		<div class="row">
			<div class="col-md-12">
				<div class="panel panel-default panel-border-color panel-border-color-primary">
					<div class="panel-heading panel-heading-divider">PRE APROBAR FICHA SOCIOECONOMICA<span class="panel-subtitle">Pre Aprobar Ficha
					...
					<div class="panel-body">
						...
						<form name="frmpreaprobarficha" id='frmpreaprobarficha' method="POST" action="{{ url('/pre-aprobar-ficha-socieconomica/'.$idopcion.'/'.$idregistro) }}" style="border-radius: 0px;" class="form-horizontal group-border-dashed" enctype="multipart/form-data">
								{{ csrf_field() }}
							...
							<div class="col-sm-8 col-sm-offset-2">
								...
								<div class="form-group">
									<label class="col-sm-3 control-label negrita">Fecha Pre Aprobacion</label>
									<div class="col-sm-6">
									       <div data-min-view="2" data-date-format="dd-mm-yyyy"  class="input-group date datetimepicker input-sm">
													...
													autocomplete="off"
													required =''
													title="Fecha de Registro de la Ficha es : {{ date_format(date_create($registro->fecha),'d-m-Y') }}"
