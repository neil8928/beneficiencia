	...
	<div class="row form-inline rowform">
		<div class="col-sm-4">
			<div class="form-group">
			    ...
			    <input type="text" class="form-control control input-xs" name="txtnombres" disabled id='txtnombres' value="@if(isset($beneficiario)){{$beneficiario->nombres}}@endif">
			</div>
		</div>
		<div class="col-sm-4">									                            	
			<div class="form-group">
				...
				name="txtapellidopaterno" id='txtapellidopaterno' disabled value="@if(isset($beneficiario)){{$beneficiario->apellidopaterno}}@endif">
			</div>
		</div>
		<div class="col-sm-4">									                            	
			<div class="form-group">
        		...
        		id='txtapellidomaterno' disabled value="@if(isset($beneficiario)){{$beneficiario->apellidomaterno}}@endif">
        	</div>
		</div>
    </div>
    ...
    <div class="row form-inline rowform">
		<div class="col-sm-4">
			<div class="form-group">
			    ...
			    <div data-min-view="2" data-date-format="dd-mm-yyyy"  disabled class="input-group date datetimepicker">
                          <input size="12" type="text" disabled
                          ...
                          <span class="input-group-addon btn btn-primary" disabled><i disabled class="icon-th mdi mdi-calendar"></i></span>
                </div>
    ...
    <div class="row form-inline rowform">
		<div class="col-sm-4">
			<div class="form-group">
			    ...
			    <input type="text" class="form-control control input-xs solonumeros validarnumero" disabled
    ...
    <div class="row rowform">
        ...
        <div class="col-sm-12">
          	<div class="form-inline divcentroderecha">
     			...
     			id='btnagregarbeneficiarioreevaluar' 
     			data_id =	'{{ $idregistro }}'
